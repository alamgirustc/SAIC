...
class Trainer(object):
    def __init__(self, args):
        ...
        self.val_evaler = Evaler(
            ...
            geo_feats_folder=cfg.DATA_LOADER.GEO_FEATS_FOLDER,  # Add this line
            add_feats_folder=cfg.DATA_LOADER.ADD_FEATS_FOLDER  # Add this line
        )
    ...
    def snapshot_path(self, name, epoch):
        #snapshot_folder = '/gdata/Alamgir/BGUS/snapshot'
    ...
    def save_model(self, epoch):
        ...
        if self.distributed and dist.get_rank() > 0:
            return
        #snapshot_folder = '/gdata/Alamgir/BGUS/snapshot'  # New directory
        snapshot_folder = os.path.join(cfg.ROOT_DIR, 'snapshot')
        if not os.path.exists(snapshot_folder):
            os.mkdir(snapshot_folder)
        torch.save(self.model.state_dict(), self.snapshot_path("caption_model", epoch + 1))

    def make_kwargs(self, indices, input_seq, target_seq, gv_feat, att_feats, att_mask, geo_feats, add_feats):
    ...
    def forward(self, kwargs):
        if self.rl_stage == False:
            ...
            add_feats = kwargs[cfg.PARAM.ADD_FEATS]
            ...
            add_feats = utils.expand_tensor(add_feats, cfg.DATA_LOADER.SEQ_PER_IMG)
    ...
    def train(self):
        ...
        for epoch in range(cfg.SOLVER.MAX_EPOCH):
            ...
            for _, (indices, input_seq, target_seq, gv_feat, att_feats, att_mask, geo_feats, add_feats) in enumerate(
                ...
                kwargs = self.make_kwargs(indices, input_seq, target_seq, gv_feat, att_feats, att_mask, geo_feats, add_feats)
