...
__C.DATA_LOADER.GEO_FEATS_FOLDER = 'gdata/Alamgir/mscoco/feature/eggcet_feats/geo_feats'  # Updated path
__C.DATA_LOADER.ADD_FEATS_FOLDER = 'gdata/Alamgir/mscoco/feature/cnn_feats/add_feats'  # Updated path
# ---------------------------------------------------------------------------- #
# Model options
# ---------------------------------------------------------------------------- #
__C.MODEL = edict()
...
__C.MODEL.ADD_DIM = 6  # Adding geometric feature dimension

__C.MODEL.DROPOUT_GEO_FEAT = 0.1  # Add the new dropout key for geometric features
__C.MODEL.DROPOUT_ADD_FEAT = 0.1
...
__C.PARAM.ADD_FEATS = 'ADD_FEATS'  # Add parameter for geometric featuresg
...
__C.INFERENCE.COCO_PATH = '/ghome/Alamgir/tri6g/coco_caption'
...
__C.SEED = -1.0
__C.TEMP_DIR = '/ghome/Alamgir/tri6g/data/temp'
