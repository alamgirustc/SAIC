...
class UpDown(AttBasicModel):
    def __init__(self):
        ...
        # First LSTM layer
        # Adjust rnn_input_size to include geometric features
    ...
    def Forward(self, **kwargs):
        ...
        geo_feats = kwargs[cfg.PARAM.GEO_FEATS]  # Add geometric features
        ...
        # Include geometric features in the attention mechanism
        att = self.att(h1_t, att_feats, p_att_feats, geo_feats)
