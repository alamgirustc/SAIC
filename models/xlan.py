...
class XLAN(AttBasicModel):
    ...
    def Forward(self, **kwargs):
        ...
        att, _ = self.attention(h_att, att_feats, att_mask, geo_feats, add_feats, p_att_feats, precompute=True)
        #print("Image att:", att)  # Print the indices (image IDs) for each batch
